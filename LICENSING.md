...
A `LICENSE-openstatus` file may sit beside this one. That is the original's licence text
...
This is a clean-room implementation of [openstatusHQ/openstatus](https://github.com/openstatusHQ/openstatus), Copyright
the openstatusHQ/openstatus authors, licensed under AGPL-3.0. It was written against a specification derived
by running that system and recording what it does, not by translating its source. See
`../openstatus-port/specs/SPEC-001-openstatus.md` for the rules it was built to, and `ACKNOWLEDGEMENTS.md` for any text carried
across and why.
